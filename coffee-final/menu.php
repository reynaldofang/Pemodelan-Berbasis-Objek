...
<html lang="en">
  <head>
    <title> Menu - ReRich Coffee Shop </title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel img" style="background-image: url(images/bg_1.jpg);">
      ...
      <div class="slider-item" style="background-image: url(images/bg_3.jpg);">
    		...
    		<div class="row no-gutters d-flex">
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(images/coffee1.jpg);"></a>
    					<div class="text p-4">
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(images/coffee2.jpg);"></a>
    					<div class="text p-4">
    						<h3>Coffee Latte</h3>
    			...
    			<div class="col-lg-4 d-flex ftco-animate">
    				<div class="services-wrap d-flex">
    					<a href="#" class="img" style="background-image: url(images/coffee5.jpg);"></a>
    					<div class="text p-4">
    						<h3>Cappucino</h3>
        ...
        <div class="row">
        	<div class="col-md-6">
					<h1 style = "text-align:center"> Coffee </h1> <br>
		              	...
		              	<div class="row">
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				...
		              				<div class="text">
		              					<h3><a href="#">Red Velvet Frappucino</a></h3>
		              					<p>A confectionery-inspired blend of chocolaty chips, mocha sauce, raspberry and vanilla syrup, topped with whipped cream.</p>
		              					<p class="price"><span>$2.90</span></p>
		              					<p><a href="#" class="btn btn-white btn-outline-white">Add to cart</a></p>
		              				</div>
		              			</div>
